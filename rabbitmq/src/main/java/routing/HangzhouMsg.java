...
public class HangzhouMsg {
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        channel.queueBind(RabbitmqConstant.QUEUE_HANGZHOU,RabbitmqConstant.EXCHANGE_ROUTING_WEATHER,"hangzhou,2022-08-01");
        channel.queueBind(RabbitmqConstant.QUEUE_HANGZHOU,RabbitmqConstant.EXCHANGE_ROUTING_WEATHER,"hangzhou,2022-08-02");
        // 每次消费消息的数量
        channel.basicQos(1);
